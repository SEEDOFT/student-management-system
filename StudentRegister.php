                ...
                <div class="form-group">
                    ...
                    <select name="cboFaculty" class="form-control" required>
                        <?php foreach ($facData as $faculty): ?>
                            <option value="<?php echo $faculty['facId']; ?>"><?php echo $faculty['facultyName']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
                    <label>Generation</label>
                    <input class="form-control" type="number" name="cboGeneration">
                </div>
                <div class="form-group">
                    <label>Group</label>
                    <input class="form-control" type="number" name="cboGroup">
                </div>
                <div class="form-group">
                    <label>Semeser</label>
